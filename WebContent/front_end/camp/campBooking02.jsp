...
<body>
		...
		<div class="header-inner responsive-wrapper">
			<div class="header-logo">
				<a style="display: inline-block; vertical-align: middle;"
					href="首頁URL"> <img src="img/header/chuba_logo.png" />
				</a> <span style="display: inline-block; vertical-align: middle;">Camping
					Paradise</span>
			</div>
			<nav class="header-navigation">
				<a href="#">Home</a> <a href="#">線上商城</a> <a href="#"><img
					src="img/header/heart.png"></a> <a href="#">註冊</a> <a href="#">登入</a>
				...
				<form method="post" action="#">
					...
					<div class="input">
						<label for="Name">營地名稱:</label> <input type="text" id="campname"
							name="campName" value="${campVO.getCampName()}" disabled />
					</div>
	...
	<c:forEach items="${seatlist}" var="orderlist">
						<div class="input">
							<label for="campAreaNameNum">營位數量:</label> 
							<input type="text"
								class="phone-number" id="campAreaNameNum" name="campAreaNameNum" value="${orderlist['campAreaName']}${orderlist['holidayNum']+orderlist['weekdayNum']}帳"
								disabled /> 
								
								
							<label for="perCapitationNum">加購人頭數量:</label>
							<input type="text" class="phone-number" id="perCapitationNum"
								name="perCapitationNum" value="${orderlist['perCapitationNum']}人" disabled /> 
								
							<label for="subtotal">小計:</label> 
							<input type="text" class="phone-number" id="subtotal" name="subtotal" value="${orderlist['subtotal']}" disabled/>
						</div>
	</c:forEach>
					...
					<div class="input">
						<label for="totalmoney">總金額:</label> <input type="text"
							class="totalmoney" id="totalmoney" name="totalmoney" value="$200"
			...
			<section class="flight-departing">
				<h2>付款人資訊</h2>
				<input type="checkbox" id="memberdata" class="memberdata" name="action" value="memberInfo">
				<label for="memberdata">同會員資料</label>
<script>
				...
				<div class="input">
					<label for="DepartingDate" class="notna">付款人姓名:</label> <input
						type="text" class="datepicker" id="payername" name="payername"
						value="JoJo" placeholder="真實姓名" required>
				...
				<div class="input">
					<label for="payertel" class="notna">聯絡電話:</label> <input type="tel"
						class="timepicker" id="payertel" name="payertel" value=""
				...
				<div class="input">
					<label for="email" class="notna">電子信箱:</label> <input type="email"
						class="" id="email" name="payeremail" value=""
						placeholder="sophie@example.com" size="32" minlength="3"
				...
				<div class="form-container">
					...
					<div class="field-container">
						<label for="cardnumber" class="notna">Card Number</label><span
							...
							type="text" pattern="[0-9]{2}/[0-9]{2}" inputmode="numeric" required>
					...
					<div class="field-container">
						<label for="expirationdate" class="notna">Expiration
							(mm/yy)</label> <input id="expirationdate" type="text" pattern="[0-9]*"
			...
			<div class="btn-wrap">
				<button type="submit" class="btn" id="submit">確認送出</button>
			</div>
		</div>
		</form>
		</section>
	...
	<script>
		window.addEventListener("load",function() {
							 var subtotal = document.querySelectorAll("input[id=subtotal]");
							    var sum = 0;
							    subtotal.forEach(function(item, i) {
							        sum += parseInt(item.value.slice(1));
							       

							    });
							    document.getElementById("totalmoney").value ='$'.concat(sum);
							////////////////////////////////////////////////////////////////////////
							var getmemberInfo = document.getElementById("memberdata");
console.log(getmemberInfo);
var data={
		 'action': 'memberInfo',
         'account':'1113'
}
getmemberInfo.addEventListener("click", function() {
	console.log(1);
    fetch("CampBookingServlet", {
    	 headers: {
    		
    	      'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
    	    },
        method: "POST", // 以 POST 為例
        body: new URLSearchParams(data) // 欲傳送的資料
...
///////////////////////////////////////////////////////////////////////							
							...
							const ccsingle = document
									.getElementById('ccsingle');
							const generatecard = document
							...
							var expirationdate_mask = new IMask(
									expirationdate,
									{
										mask : '00/00',
							...
							cardnumber_mask
									.on(
											...
											function() {
												console
														.log(cardnumber_mask.masked.currentMask.cardtype);
							...
							const randomCard = function() {
								let testCards = [ '4000056655665556',
										'5200828282828210', '371449635398431',
										'6011000990139424', '30569309025904',
							...
							document.querySelector('.preload').classList
									.remove('preload');
									...
									.addEventListener(
											...
											function() {
												if (name.value.length == 0) {
													document
															.getElementById('svgname').innerHTML = 'John Doe';
													document
															.getElementById('svgnameback').innerHTML = 'John Doe';
												} else {
													document
															.getElementById('svgname').innerHTML = this.value;
													document
															.getElementById('svgnameback').innerHTML = this.value;
												}
											});
									...
									.on(
											...
											function() {
												if (cardnumber_mask.value.length == 0) {
													document
															.getElementById('svgnumber').innerHTML = '0123 4567 8910 1112';
												} else {
													document
															.getElementById('svgnumber').innerHTML = cardnumber_mask.value;
												}
											});
									...
									.on(
											...
											function() {
												if (expirationdate_mask.value.length == 0) {
													document
															.getElementById('svgexpire').innerHTML = '01/23';
												} else {
													document
															.getElementById('svgexpire').innerHTML = expirationdate_mask.value;
												}
											});
									...
									.on(
											...
											function() {
												if (securitycode_mask.value.length == 0) {
													document
															.getElementById('svgsecurity').innerHTML = '985';
												} else {
													document
															.getElementById('svgsecurity').innerHTML = securitycode_mask.value;
												}
											});
